...
class CommandDispatcher:
    def __init__(self) -> None:
        ...
        self.register(["открой гугл почту"], open_url, url="https://mail.google.com/")
        self.register(["открой майл ру"], open_url, url="https://mail.ru/")
        self.register(["открой ютуб"], open_url, url="https://youtube.com/")
